...
$(document).ready(function(){  
    ...
    if( navigator.geolocation )  
     navigator.geolocation.watchPosition(currMarker, fail, optn);  
    else  
...
function showInfoWindow(){
  ...
  for (var i = 0; i < markers.length; i++) {
    ...
    var input_report_id = document.getElementById('input_report_id')
    input_report_id.value = a.report_id
